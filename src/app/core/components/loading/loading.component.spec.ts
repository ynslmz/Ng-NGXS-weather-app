...
describe('LoadingComponent', () => {
      ...
      providers: [
        {
          ...
          // no need any service to test showing loading
          useValue: {}
        }
      ]
    }).compileComponents();
  ...
  it('should hide loading when dispatch delete request', () => {
    store = TestBed.inject(Store);
    store.dispatch(new DeleteRequest("test"));
    fixture.detectChanges();
    const compiled = fixture.nativeElement;
    expect(compiled.querySelector('span.fs-3')).toBeNull();
  });
