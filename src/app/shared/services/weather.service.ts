...
export class WeatherService {
  ...
  getDetailOfCity(lat: number, long: number, unit: string): Observable<DetailOfCity> {
    return this.httpClient.get<DetailOfCity>(`${environment.apiUrl.weather}/onecall?lat=${lat}&lon=${long}&exclude=current,minutely,daily,alerts&appid=${environment.apiId}&units=${unit}`)
  }
}
